    ...
    >
      ...
      {step === 2 && (
        <>
          <h2>Питання 2 з 6</h2>
          <p>
            <strong>Які проблеми шкіри вас турбують зараз?</strong>
          </p>
      ...
      {step === 6 && (
        <>
          ...
          <p>
            Дякуємо! На основі ваших відповідей ми проаналізували стан вашої
            шкіри та підготували персональні рекомендації.
          </p>
          ...
          >
            <p>
              <strong>Тип шкіри:</strong> {skinType}
            </p>
            <p>
            ...
            <p>
              <strong>Вік:</strong> {ageRange}
            </p>
            <p>
              <strong>Чутливість:</strong> {sensitivity}
            </p>
            <p>
        ...
        <>
          ...
          <div style={{ marginTop: 24, display: "grid", gap: 20 }}>
            ...
            >
              ...
              <p>Базовий догляд для підтримки шкіри та роботи з основними проблемами.</p>
              <ul>
                <li>Очищення</li>
                <li>Зволоження</li>
                <li>Захист шкіри</li>
            ...
            >
              ...
              <p>
                Рекомендований варіант для комплексного догляду та видимого
                результату.
              </p>
              <ul>
                <li>Очищення</li>
            ...
            >
              ...
              <p>
                Максимальний ефект, anti-age та глибока робота з проблемами
                шкіри.
              </p>
              <ul>
